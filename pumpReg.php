                    ...
                    <form action="" method="post">
                        <div class="row gy-4 mb-3 ">
                            <div class="col-lg-6 form-group">
                                <input type="text" name="name" class="form-control" id="name" placeholder="Pump Name" required>
                            </div>
                            <div class="col-lg-6 form-group">
...
if (isset($_POST['submit'])) {
    ...
    if ($password == $cPassword) {
        $qry = "INSERT INTO `pump` (`pump`,`email`,`phone`,`address`,`district`,`pin`,`reg_no`) VALUES ('$name','$email','$phone','$address','$district','$pin','$reg')";
        // echo $qry;
        $qryLog = "INSERT INTO `login` (`uid`,`username`,`password`,`usertype`,`status`) VALUES ((SELECT MAX(`pid`) FROM `pump`), '$email','$password','Pump','Active')";
        // echo $qryLog;
